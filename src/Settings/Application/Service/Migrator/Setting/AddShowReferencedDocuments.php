...
final class AddShowReferencedDocuments implements FileMigration
{
    ...
    public function migrate(string $file, FileType $type): void
    {
        ...
        if (
            ...
            || array_key_exists('show_referenced_documents', $jsonArr['chatbot']['general'])
        ) {
            // Nothing to do :)
            return;
        }

        $jsonArr['chatbot']['general']['show_referenced_documents'] = true;

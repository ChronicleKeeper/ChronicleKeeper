...
class GetAllVectorSearchDocumentsQuery implements Query
{
    ...
    {
        assert($parameters instanceof GetAllVectorSearchDocuments);
        ...
        foreach ($files as $file) {
            try {
                ...
                $vectorDocuments[] = $this->serializer->deserialize($content, SearchVector::class, 'json');
